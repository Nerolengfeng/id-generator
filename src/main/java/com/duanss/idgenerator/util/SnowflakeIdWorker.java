package com.duanss.idgenerator.util;
...
public class SnowflakeIdWorker {
    ...
    /**
     * 开始时间戳 (2019-10-24 00:00:00)
     */
    private final long twepoch = 1571846400L;
    /**
     * 序列在id中占的位数
     */
    ...
    public static void main(String[] args) {
        ...
        final ConcurrentHashMap<Long, Integer> concurrentHashMap = 
                new ConcurrentHashMap<Long, Integer>((int) threadSegmentCnt * cntPerThread + 1);
